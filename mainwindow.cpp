...
#include "mainequip.h"  // Include MainEquip
#include <QMessageBox>
#include <QSqlError>
...
MainWindow::MainWindow(QWidget *parent)
    ...
    , mainArch(nullptr)
    , mainClient(nullptr)
    , mainEquip(nullptr)  // Initialize mainEquip to nullptr
{
    ui->setupUi(this);
    setupRFIDInterface();
    ...
    connect(ui->orders_btn_3, &QPushButton::clicked,
            this, &MainWindow::on_orders_btn_3_clicked);  // Connect orders_btn_3
...
MainWindow::~MainWindow()
{
    delete mainArch;
    delete mainClient;
    delete mainEquip;  // Clean up mainEquip
    delete ui;
}
